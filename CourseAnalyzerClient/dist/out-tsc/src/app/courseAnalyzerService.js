'use strict';
angular.module('CourseAnalyzer.services')
    .factory('courseAnalyzerService', ['$q', '$http', 'CONSTANTS', function ($q, $http, CONSTANTS) {
        var service = {};
...
//# sourceMappingURL=courseAnalyzerService.js.map